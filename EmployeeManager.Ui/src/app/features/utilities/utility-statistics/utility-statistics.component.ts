import { Component, computed, DestroyRef, effect, inject, input, OnDestroy, OnInit, signal, untracked } from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';
import { Department } from '../../../shared/models/department.model';
import { PaymentType, UtilityPaymentStatistics } from '../../../shared/models/utility-payment.model';
...
@Component({
  selector: 'app-utility-statistics',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './utility-statistics.component.html',
  styleUrl: './utility-statistics.component.css',
})
export class UtilityStatisticsComponent implements OnInit, OnDestroy {
  ...
  statistics = signal<UtilityPaymentStatistics | null>(null);

  expensesChart: Chart | null = null;
  consumptionChart: Chart | null = null;

  paymentTypeName = computed(() => {
  ...
  private updateCharts(): void {
    ...
    this.createConsumptionChart(stats);
  }

  private createExpensesChart(stats: UtilityPaymentStatistics): void {
    ...
    const config: ChartConfiguration<'line'> = {
      ...
      options: {
        ...
        plugins: {
          title: {
            display: true,
            text: `Динаміка витрат на ${this.paymentTypeName()}`,
  ...
  private createConsumptionChart(stats: UtilityPaymentStatistics): void {
    ...
    const config: ChartConfiguration<'line'> = {
      ...
      options: {
        ...
        plugins: {
          title: {
            display: true,
            text: `Динаміка споживання ${this.paymentTypeName()}`,
            color: 'var(--text-primary, #fff)',
          },
          legend: {
            labels: {
    ...
    this.consumptionChart = new Chart(canvas, config);
  }
